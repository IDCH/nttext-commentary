...
public abstract class AbstractTokenSequence implements TokenSequence {
     ...
     *      marker).
     * 
     * @see org.idch.texts.TokenSequence#isEmpty()
     */
    @Override
    ...
    /**
     * 
     * @see org.idch.texts.TokenSequence#size()
     */
    @Override
    public int size() {
     ...
     * if it is empty.
     * 
     * @see org.idch.texts.TokenSequence#getText()
     */
    @Override
     ...
     * @see org.idch.texts.TokenSequence#contains(org.idch.texts.Token)
     */
    @Override
     ...
     * 
     * @see org.idch.texts.TokenSequence#indexOf(org.idch.texts.Token)
     */
    @Override
     ...
     *      (index < 0 || index >= size())
     *      
     * @see org.idch.texts.TokenSequence#get(int)
     */
    @Override
     ...
     * 
     * @see org.idch.texts.TokenSequence#toArray(org.idch.texts.Token[])
     */
    @Override
