...
public class MySQLEntryRepository implements EntryRepository {
    ...
    public Entry create(Entry entry) {
        ...
        try {
            ...
            stmt.setString(PASSAGE, entry.getReference().toString());
            ...
            String msg = "Could not create entry: " + entry.getReference() + ". " + ex.getMessage();
            LOGGER.warn(msg, ex);
            entry = null;
        } finally {
    ...
    public boolean remove(Entry entry) {
        ...
        try {
            ...
            String msg = "Could not remove entry: " + entry.getReference() + ". " + ex.getMessage();
            LOGGER.warn(msg, ex);
            success = false;
        } finally {
            repo.closeConnection(conn);
